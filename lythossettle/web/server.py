"""
lythossettle.web.server — the local HTTP server that serves the interface.
...
interface keeps answering while thousands of samples are analysed.
"""
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        try:
            ...
            if route == "/api/plot":
                ...
                kind = query.get("kind", ["schematic"])[0]
    ...
    def _project(self, data: dict) -> None:
        ...
        self._download("project.settle", payload, "application/json; charset=utf-8")
    ...
    def _report(self, data: dict) -> None:
        ...
        name = f"lythossettle_report.{fmt}"
    ...
    def _export_study(self, data: dict) -> None:
        ...
        name = f"lythossettle_study.{kind}"
        with tempfile.TemporaryDirectory() as tmp:
...
def serve(host: str = "127.0.0.1", port: int = 8780, open_browser: bool = True,
          lang: str = "en") -> None:
